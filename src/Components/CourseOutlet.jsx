...
const CourseOutlet = () => {
  return (
    <section className="w-full max-w-[1600px] mx-auto px-6 flex items-center gap-8 justify-between my-16">
      <img src="/courseOutlet.png" alt="image" className="w-[600px]" />
      <div className="w-[40%]">
        <h3 className="text-[30px] font-[700] text-textColor">
          You Can Learn, Wherever You Want
        </h3>
        <p className="text-[18px]  text-textColor font-[500] mt-3">
